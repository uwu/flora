...
deno_core::extension!(
    ...
    ops = [
        ...
        commands::op_create_global_command,
        commands::op_edit_global_command,
        commands::op_delete_global_command,
        commands::op_get_global_commands,
        commands::op_get_global_command,
