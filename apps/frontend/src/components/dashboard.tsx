...
export function Dashboard() {
  ...
  const [guilds, setGuilds] = useState<LoadState<components['schemas']['GuildResponse'][]>>({
    ...initialState
  })
                                          ...
                                          <div className='flex items-center gap-4'>
                                            ...
                                            <div>
                                              <p className='font-medium text-sm'>
                                                {guilds.data?.find((g) => g.id === dep.guild_id)
                                                  ?.name ||
                                                  dep.guild_id}
                                              </p>
                    ...
                    <div className='flex-1 p-4 md:p-6 lg:p-8'>
                      <div className='flex h-full flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-500'>
                        ...
                        <p className='text-muted-foreground mt-2 max-w-sm'>
                          Select a guild from the sidebar to manage its bot deployment, view
                          history, or configure settings.
                        </p>
                      </div>
                    </div>
                  )}
