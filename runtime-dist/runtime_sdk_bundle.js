...
const rest = {
	...
	createGlobalCommand: (args) => ops.op_create_global_command(args),
	editGlobalCommand: (args) => ops.op_edit_global_command(args),
	deleteGlobalCommand: (args) => ops.op_delete_global_command(args),
	getGlobalCommands: () => ops.op_get_global_commands(),
	getGlobalCommand: (args) => ops.op_get_global_command(args),
