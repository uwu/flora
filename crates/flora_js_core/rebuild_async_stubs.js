...
const doNotModify = '/* DO NOT MODIFY: use rebuild_async_stubs.js to regenerate */\n'
...
const infraPristine = infraJs.replaceAll(
  /\/\* BEGIN TEMPLATE ([^ ]+) \*\/.*?\/\* END TEMPLATE \*\//gms,
  'TEMPLATE-$1'
)
...
const asyncStubIndent = infraPristine.match(/^([\t ]+)(?=TEMPLATE-setUpAsyncStub)/m)[0]

const infraOutput = infraPristine.replace(
