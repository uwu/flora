...
pub(crate) struct ExceptionState {
    ...
    pub(crate) js_build_custom_error_cb: RefCell<Option<v8::Global<v8::Function>>>,
    ...
    pub(crate) js_handled_promise_rejection_cb: RefCell<Option<v8::Global<v8::Function>>>,
...
impl ExceptionState {
    ...
    pub(crate) fn set_dispatched_exception(&self, exception: v8::Global<v8::Value>, promise: bool) {
            ...
            PromiseHandlerAddedAfterReject => {
                ...
                if rejections.len() == previous_len {
                    ...
                    if self.js_handled_promise_rejection_cb.borrow().is_some() {
                        ...
                        let error_global = v8::Global::new(scope, error);
                        self.pending_handled_promise_rejections
                            .borrow_mut()
