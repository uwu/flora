...
impl<'a, T: serde::Serialize> RustToV8Fallible<'a> for RustToV8Marker<SerdeMarker, T> {
    #[inline(always)]
    fn to_v8_fallible<'i>(
        self,
        scope: &mut v8::PinScope<'a, 'i>,
    ...
    for RustToV8Marker<CppGcMarker, T>
{
    #[inline(always)]
    fn to_v8<'i>(self, scope: &mut v8::PinScope<'a, 'i>) -> v8::Local<'a, v8::Value> {
        v8::Local::<v8::Value>::from(deno_core::cppgc::make_cppgc_object(scope, self.0))
    }
}
...
impl<'a, T: crate::ToV8<'a>> RustToV8Fallible<'a> for RustToV8Marker<ToV8Marker, T> {
    #[inline(always)]
    fn to_v8_fallible<'i>(
        self,
        scope: &mut v8::PinScope<'a, 'i>,
