    ...
    pub fn load(&self) -> Result<ModuleCodeString, std::io::Error> {
        ...
        match &self.code {
            ...
            ExtensionFileSourceCode::LoadedFromFsDuringSnapshot(path) => {
                #[allow(clippy::disallowed_methods, reason = "load extensions from real fs")]
...
pub type GlobalTemplateMiddlewareFn = for<'s, 'i> fn(
    &mut v8::PinScope<'s, 'i, ()>,
...
impl Extension {
    ...
    pub fn get_global_template_middleware(&mut self) -> Option<GlobalTemplateMiddlewareFn> {
        self.global_template_middleware
    }

    pub fn get_global_object_middleware(&mut self) -> Option<GlobalObjectMiddlewareFn> {
