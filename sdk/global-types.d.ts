...
declare global {
  ...
  class EmbedBuilder {
    ...
    toJSON(): { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; };
  }
  ...
  type Embed = { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; };
  ...
  type EventMember = { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; };

  type EventMessage = { id: string; channelId: string; guildId?: string; content: string; author: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; };

  type EventMessageUpdate = { id: string; channelId: string; guildId?: string; content?: string; author?: { id: string; username: string; discriminator?: number; bot: boolean; }; editedTimestamp?: string; old?: { id: string; channelId: string; guildId?: string; content: string; author: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; }; new?: { id: string; channelId: string; guildId?: string; content: string; author: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; }; };
  ...
  type EventReady = { user: { id: string; username: string; discriminator?: number; bot: boolean; }; guildIds: string[]; };

  type EventInteractionCreate = { interactionId: string; interactionToken: string; applicationId: string; guildId?: string; channelId?: string; user: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; commandName: string; data: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; locale?: string; guildLocale?: string; };

  type EventComponentInteraction = { interactionId: string; interactionToken: string; applicationId: string; guildId?: string; channelId?: string; user: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; data: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; locale?: string; guildLocale?: string; messageId?: string; };

  type EventModalSubmit = { interactionId: string; interactionToken: string; applicationId: string; guildId?: string; channelId?: string; user: { id: string; username: string; discriminator?: number; bot: boolean; }; member?: { user: { id: string; username: string; discriminator?: number; bot: boolean; }; nick?: string; avatar?: string; roles: string[]; joinedAt?: string; premiumSince?: string; deaf: boolean; mute: boolean; flags: number; pending: boolean; permissions?: string; communicationDisabledUntil?: string; }; data: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; locale?: string; guildLocale?: string; messageId?: string; };

  type EventReaction = { userId?: string; channelId: string; messageId: string; guildId?: string; emoji: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; burst: boolean; };

  type EventReactionRemoveAll = { messageId: string; channelId: string; guildId?: string; };

  type RawKvKeyMetadata = { expiration?: bigint; metadata?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; };

  type RawKvKeyInfo = { name: string; expiration?: bigint; metadata?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; };

  type RawKvListKeysResult = { keys: { name: string; expiration?: bigint; metadata?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; }[]; listComplete: boolean; cursor?: string; };

  type RawKvSetOptions = { expiration?: bigint; metadata?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; };
  ...
  type RawEmbed = { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; };

  type RawSendMessage = { channelId: string; content?: string; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; attachments?: { url: { url: string; filename?: string; description?: string; }; } | { base64: { data: string; filename: string; description?: string; }; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; tts?: boolean; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; flags?: bigint; messageId?: string; replyTo?: string; };

  type RawEditMessage = { channelId: string; messageId: string; content?: string; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; flags?: bigint; };
  ...
  type RawInteractionResponse = { interactionId: string; token: string; content?: string; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; attachments?: { url: { url: string; filename?: string; description?: string; }; } | { base64: { data: string; filename: string; description?: string; }; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; tts?: boolean; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; ephemeral?: boolean; flags?: bigint; };

  type RawUpsertGuildCommands = { guildId: string; commands: { name: string; description?: string; options?: { name: string; description: string; kind?: string; required?: boolean; options?: RawSlashCommandOption[]; }[]; }[]; };

  type RawSlashCommand = { name: string; description?: string; options?: { name: string; description: string; kind?: string; required?: boolean; options?: RawSlashCommandOption[]; }[]; };

  type RawSlashCommandOption = { name: string; description: string; kind?: string; required?: boolean; options?: RawSlashCommandOption[]; };

  type RawDeferInteractionResponse = { interactionId: string; token: string; ephemeral?: boolean; };

  type RawUpdateInteractionResponse = { interactionId: string; token: string; content?: string; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; attachments?: { url: { url: string; filename?: string; description?: string; }; } | { base64: { data: string; filename: string; description?: string; }; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; tts?: boolean; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; flags?: bigint; };

  type RawEditInteractionResponse = { token: string; content?: string; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; attachments?: { url: { url: string; filename?: string; description?: string; }; } | { base64: { data: string; filename: string; description?: string; }; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; flags?: bigint; };
  ...
  type RawCreateGuildCommand = { guildId: string; command: { name: string; description?: string; options?: { name: string; description: string; kind?: string; required?: boolean; options?: RawSlashCommandOption[]; }[]; }; };

  type RawEditGuildCommand = { guildId: string; commandId: string; command: { name: string; description?: string; options?: { name: string; description: string; kind?: string; required?: boolean; options?: RawSlashCommandOption[]; }[]; }; };

  type RawDeleteGuildCommand = { guildId: string; commandId: string; };

  type RawGetGuildCommand = { guildId: string; commandId: string; };

  type RawCommandPermissions = { guildId: string; commandId: string; permissions: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; };
  ...
  type RawEditMember = { guildId: string; userId: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };

  type RawCreateChannel = { guildId: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };

  type RawEditChannel = { channelId: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };

  type RawDeleteChannel = { channelId: string; reason?: string; };

  type RawCreateThread = { channelId: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };

  type RawCreateThreadFromMessage = { channelId: string; messageId: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };

  type RawThreadId = { threadId: string; };

  type RawThreadMember = { threadId: string; userId: string; };

  type RawExecuteWebhook = { webhookId: string; token: string; wait?: boolean; threadId?: string; withComponents?: boolean; content?: string; username?: string; avatarUrl?: string; tts?: boolean; embeds?: { title?: string; description?: string; url?: string; color?: number; timestamp?: string; footer?: { text?: string; iconUrl?: string; }; image?: { url?: string; }; thumbnail?: { url?: string; }; author?: { name?: string; url?: string; iconUrl?: string; }; fields?: { name: string; value: string; inline: boolean; }[]; }[]; attachments?: { url: { url: string; filename?: string; description?: string; }; } | { base64: { data: string; filename: string; description?: string; }; }[]; components?: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null[]; allowedMentions?: { parse?: string[]; users?: string[]; roles?: string[]; repliedUser?: boolean; }; flags?: bigint; threadName?: string; };

  type RawEditWebhook = { webhookId: string; token?: string; payload: number | string | boolean | Array<JsonValue> | { [key in string]?: JsonValue; } | null; reason?: string; };
